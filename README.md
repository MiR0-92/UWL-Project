...
A Classic Pac-Man game fork with dynamic join/exit, where you scan the QR code on the screen and your phone serves as the controller, while playing the game on an external screen.
